...
so D3D8 support is now disabled by default.  If you really want to docs
...
/** If this is commented out, Irrlicht will try to compile using the jpeg cmake installed in the system.
...
// To docs Irrlicht as a static library, you must define _IRR_STATIC_LIB_ in both the
// Irrlicht docs, *and* in the user application, before #including <irrlicht.h>
